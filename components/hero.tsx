      ...
      <div className="flex flex-1 flex-col items-start justify-center px-6 pt-24 md:px-12">
        <div className="max-w-xl">
          ...
          >
            <a
              href="#enquire"
              className="press-bounce-late inline-flex h-12 items-center justify-center rounded-full bg-coral px-9 text-[0.74rem] font-medium uppercase tracking-[0.16em] text-espresso transition-colors duration-200 hover:bg-cream"
            >
