...
export function WhatsAppFab({ utm = "fab" }: { utm?: string } = {}) {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-espresso text-cream shadow-[0_8px_30px_rgba(36,27,22,0.35)] transition-colors duration-200 hover:bg-coral hover:text-espresso"
    >
